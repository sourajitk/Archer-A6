...
#endif
#define DEFAULT_PORTALBGRJPG "/etc/wifidog/portal.jpg"
#define DEFAULT_PORTALLOGOJPG "/etc/wifidog/portal-head.png"
#define DEFAULT_PORTALLANJS "/etc/wifidog/lan.js"
#define DEFAULT_PORTALJQUER "/etc/wifidog/jquery.min.js"
#define DEFAULT_PORTALICONPNG "/etc/wifidog/portal-icon.png"




#define DEFAULT_USERPORTALBGRJPG "/tmp/portal_back.jpg"
#define DEFAULT_USERPORTALLOGOJPG "/tmp/portal_logo.jpg"
