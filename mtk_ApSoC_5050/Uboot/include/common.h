...
#define ALIGN_LEFT(x,y) (x/y*y)
typedef struct
   {
   uint32_t magic;
   uint32_t boot_address;
   uint32_t boot_image_addr;
   }
uboot_data;
extern uboot_data g_uboot_data;
enum ERR_BOOTM_t
{	
	ERR_BOOTM_OK = 0,
	ERR_BOOTM_MAGIC_DISMATCH,
	ERR_BOOTM_TYPE_DISMATCH,
	ERR_BOOTM_TRY_UBOOT,
};
...
extern unsigned int load_uboot_data_addr;		/* Default Load Address */
