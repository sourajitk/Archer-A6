...
/* space address for swap */
#define CFG_NAND_LOAD_SWAP_ADDR		(CFG_LOAD_ADDR + 0x1000000)
/* address for factory boot load the boot2 */
#define CFG_NAND_LOAD_BOOT2_ADDR	(CFG_NAND_LOAD_SWAP_ADDR + 0x100000)
/* space address for environment params transform to next uboot */
#define CFG_BOOT_ENV_MEM_ADDR		(CFG_NAND_LOAD_BOOT2_ADDR + 0x0f0000)
/* space size for environment params transform to next uboot */
#define CFG_BOOT_ENV_MEM_SIZE		(0x010000)
/* space address for kernel */
#define CFG_NAND_LOAD_KERNEL_ADDR	(CFG_NAND_LOAD_BOOT2_ADDR + 0x100000)
/* spare address for load whole flash */
#define CFG_NAND_LOAD_IMAGE_ADDR	(CFG_NAND_LOAD_KERNEL_ADDR + 0x400000)
...
/* we do not use mtk partition table. */
#if 0
...
#define CFG_NEXT_BOOT_OFFSET	( (CONFIG_NEXT_BOOT_OFFSET))

#ifdef BOOT_NEXT_UBOOT
#define CFG_NEXT_BOOT_TYPE IH_TYPE_STANDALONE
#elif defined(BOOT_NEXT_KERNEL)
#define CFG_NEXT_BOOT_TYPE IH_TYPE_KERNEL
#elif defined(BOOT_NEXT_IMAGE)
#define CFG_NEXT_BOOT_TYPE IH_TYPE_FIRMWARE
#elif defined(BOOT_NEXT_ALL)
#define CFG_NEXT_BOOT_TYPE IH_TYPE_INVALID
#else
#define CFG_NEXT_BOOT_TYPE IH_TYPE_INVALID
#endif

#ifndef CONFIG_BREAK_BOOTING_BUTTON
#define CONFIG_BREAK_BOOTING_BUTTON 4
#endif

#ifndef CONFIG_PRESS_BUTTON_ENTER_RECOVERY_SECONDS
#define CONFIG_PRESS_BUTTON_ENTER_RECOVERY_SECONDS 3
#endif

#ifndef CONFIG_UBOOT_NAME
...
#if 0
#define BOOT_OS0_ADDR		"BootOs0Addr"
#define BOOT_OS1_ADDR		"BootOs1Addr"
#endif

#define IMAGE0_PART_NAME "os0"
#define IMAGE1_PART_NAME "os1"
#define UBOOTENV_PART_NAME "ubootenv"
#define UBOOT_PART_NAME "uboot"



//#define BOOT_IMAGE_NAME "BootImage"

//#define BAD_IMAGE "BadImage"
#define ENV_MAGIC		0x48534C46	/* 'FLSH' */

#define NO_FIRMWARE_CHECK_ENV "no_firmware_check"

#define NAND_FLASH_BOOT_IMAGE_LZ "vmlinuz"
#define NAND_CFE_RAM_NAME		 "cferam.000"
#define NAND_KERNEL_TAG			 "tag_kernel"
#define NAND_IMAGE_OFFSET_MAX_NUM	8

#define ENV_IMAGE_BOOT 		"image_boot"
#define ENV_IMAGE_LEN 		"image_len"
#define ENV_IMAGE_COPY		"image_copy"
#define IMAGE_NEED_COPY		'0'
#define IMAGE_NOT_COPY		"1"

#if 0
#define FACT_BOOT_OS_ADDR "FactBootOsAddr"
#endif

#ifdef CHECK_DUAL_IMAGE_AND_BOOT

#if 0
#define CFG_IMAGE0_ADDR		(CFG_FLASH_BASE +(CONFIG_FIRST_IMAGE_OFFSET))
#define CFG_IMAGE0_SIZE			(CONFIG_IMAGE_SIZE)

#define CFG_IMAGE1_SIZE			(CONFIG_IMAGE_SIZE)
#define CFG_IMAGE1_ADDR		(CFG_FLASH_BASE +(CONFIG_SECOND_IMAGE_OFFSET))
#endif

#define UPGRADE_FLAG_NAME "UpgradeStatus"
/* This status indicates the system is doing firmware upgrading. Set by user-space.*/
#define UPGRADE_STATUS_UPGRADING	"UPGRADING"
/* This status indicates the upgrading is completed, but need to checked by uboot. Set by user-space.*/
//#define UPGRADE_STATUS_UPGRADED_NEED_CHECK	"UPGRADING_NEED_CHECK"

/* This status indicates the upgrading is completed, but need to checked by uboot. Set by user-space.*/
//#define UPGRADE_STATUS_CHECKED_BY_UBOOT	"UPGRADING_CHECKED_BY_UBOOT"

/* This status indicated the upgrade firmware is wrong. The user-space should read it and take action. */
//#define UPGRADE_STATUS_UP_FIRMWARE_ERROR		"UPBIN_ERROR"
/* The upgrade process is terrupted! */
//#define UPGRADE_STATUS_INTERRUPTED			"UPGRADING_INTERRUPTED"

//#define UPGRADE_STATUS_CHECK_OK			"UPGRADING_CHECK_OK"

//#define DEFAULT_BOOT_IMAGE "0"

//#define UPGRADE_IMAGE_NAME "UpgradeImage"

//#define UPGRADE_IMAGE_TRY_TIMES "UpgradeImageTry"
...
#define CFG_ENV_ADDR		(CFG_FLASH_BASE + CONFIG_ENV_OFFSET)
 ...
 */
#define CONFIG_FW_RECOVERY_ADDR					0x80500000
