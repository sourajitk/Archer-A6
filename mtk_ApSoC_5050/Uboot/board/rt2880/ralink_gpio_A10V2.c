...
typedef enum
{
	...
	GPIO_LED_2G = 16,
    GPIO_LED_5G = 15,
    GPIO_LED_INTERNET_13 = 13,
    GPIO_LED_INTERNET_14 = 14,
    GPIO_LED_LAN = 9,
    GPIO_LED_WPS = 5,
    GPIO_BUTTON_BOARD = 7,
    GPIO_LED_BOARD = 8,
...
void ralink_gpio_init(void)
{
	...
	*(volatile u32 *)(RALINK_REG_GPIOMODE) = cpu_to_le32(gpiomode);
    ...
    /* high valid , orange*/
    set_gpio_dir(GPIO_LED_INTERNET_13, DIR_OUTPUT);
     
    /* low valid , white*/
    set_gpio_dir(GPIO_LED_INTERNET_14, DIR_OUTPUT);
...
void all_led_check(int step)
{
	...
	else if(1 == step)
	{
		...
		/* high valid , orange*/
	    set_gpio_data(GPIO_LED_INTERNET_13, OUTPUT_HIGH);
	     
	    /* low valid , white*/
	    set_gpio_data(GPIO_LED_INTERNET_14, OUTPUT_HIGH);
	}
	//mdelay(1000);
	...
	else if(2 == step)
	{
	    ...
	    /* high valid , orange*/
	    set_gpio_data(GPIO_LED_INTERNET_13, OUTPUT_LOW);
...
void all_led_on()
{
    ...
    /* low valid , white*/
    set_gpio_data(GPIO_LED_INTERNET_14, OUTPUT_LOW);
