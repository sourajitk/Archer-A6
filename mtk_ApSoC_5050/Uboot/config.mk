...
CPPFLAGS := $(DBGFLAGS) $(OPTFLAGS) $(RELFLAGS)		\
	-D__KERNEL__ -D__UBOOT__ -DTEXT_BASE=$(TEXT_BASE) 		\
	-I$(TOPDIR)/include				\
...
##enable model-specific feature, like LED
ifeq ($(MODEL_FEATURE),ON)
CPPFLAGS += -DMODEL_FEATURE
endif

ifeq ($(NET_FEATURE),ON)
CPPFLAGS += -DNET_FEATURE
endif

ifeq ($(MINI_WEB_SERVER_SUPPORT),y)
CPPFLAGS += -DMINI_WEB_SERVER_SUPPORT
endif

ifeq ($(CONFIG_LED_CHECK),y)
CPPFLAGS += -DCONFIG_LED_CHECK
endif

ifeq ($(CONFIG_CHECK_UP_SIG),y)
CPPFLAGS += -DCONFIG_CHECK_UP_SIG
endif

ifeq ($(CONFIG_COMPATIBLE_WITH_IPF),y)
CPPFLAGS += -DCONFIG_COMPATIBLE_WITH_IPF
endif
