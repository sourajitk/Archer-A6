...
/*=======================================================================*/
/* We do not use mtk partitions. Use uboot mtdpart instead. By xjb, 2017.11.10 */
#if 0
...
#else
struct mtd_partition_mtk{
	const char *name;
	uint64_t size;
	uint64_t offset;
};

static struct mtd_partition_mtk g_pasStatic_Partition[MAX_PARTITIONS_NUM];
#endif
