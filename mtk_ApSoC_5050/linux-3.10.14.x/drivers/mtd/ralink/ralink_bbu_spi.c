...
/* Do not use static partition table. Use uboot mtdpart instead */
#if 0
...
/* We do not use it. By xjb, 2017.11.10 */
#if 0
...
/* Use mtdparts in uboot.*/
	...
	mtd_device_parse_register(&flash->mtd, NULL, NULL, partitions, ARRAY_SIZE(partitions));
#endif
	return &flash->mtd;
#endif
}
